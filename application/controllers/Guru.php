...
class Guru extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->load->view('login_guru.php',$data);
	...
	{
        $user_id = $this->guruM->mydb->params = array(
            'id' => $_SESSION['id']
        );

        $aku = $this->guruM->mydb->get($user_id);
    ...
    public function sudah_mpk()
    {
        ...
        //echo "status_vote_mpk yeuh : ".$_SESSION['status_vote_mpk'];
            ...
            $kandidat = $this->kandidatM->mydb->get();
            $data['kandidat'] = $kandidat;
            $this->load->view('mpk_sudah_g',$data);
    ...
    public function sudah_osis()
    {
        ...
        //echo "status_vote_mpk yeuh : ".$_SESSION['status_vote_mpk'];
            ...
            $kandidat = $this->kandidatM->mydb->get();
            $data['kandidat'] = $kandidat;
            $this->load->view('osis_sudah_g',$data);
	 ...
	 public function voting_mpk()
    {
        ...
        $res = $this->guruM->mydb->edit($data_update,$id_guru);
