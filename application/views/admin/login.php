...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url();?>resources/adminlte/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>"><b>AVK</b>MO</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="<?php echo base_url();?>admin/Login/ceklogin" method="post">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="hide checkbox icheck">
            <label>
...
<!-- iCheck -->
<script src="<?php echo base_url();?>resources/adminlte/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
