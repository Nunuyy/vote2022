  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Master Data Siswa
        <small>Siswa yang terdaftar sebagai pemilih</small>
      </h1>
      <ol class="breadcrumb">
              ...
              <table id="example2" class="table table-bordered table-striped" style="width:100%">
                ...
                <?php $no=1; foreach ($siswa as $row) { ?>
                        <tr>
                            ...
                            <td><?php echo $row['password'];?></td><td><?php echo $row['login_time'];?></td>
                            <td><?php 
      ...
      <!-- <div class="box">
        ...
        <div class="box-body">
          <table id="example2" class="display" style="width:100%">
              ...
              <tbody>
                      <tr>
                          <td><?php echo "test";//$no;?></td>
                          <td><?php echo "test";//$row['id'];?></td>
                          <td><?php echo "test";//$row['nama'];?></td>
                          <td><?php echo "test";//$row['kelas'];?></td>
                          <td><?php echo "test";//$row['password'];?></td>
                          <td><?php echo "test";//$row['login_time'];?></td>
                          <td><?php echo "test";//$row['status_vote_mpk'];?></td>
                          <td><?php echo "test";//$row['vote_mpk'];?></td>
                          <td><?php echo "test";//$row['vote_mpk_time'];?></td>
                          <td><?php echo "test";//$row['status_vote_osis'];?></td>
                          <td><?php echo "test";//$row['vote_osis'];?></td>
                          <td><?php echo "test";//$row['vote_osis_time'];?></td>
                      </tr>
              <?php $no=1; foreach ($siswa as $row) { ?>
                      <tr>
                          <td><?php echo $no;?></td>
                          ...
                          <td><?php echo "<span class='label label-success'>".$row['status_vote_mpk']."</span>";?></td>
                          <td><?php echo $row['vote_mpk'];?></td>
                          <td><?php echo $row['vote_mpk_time'];?></td>
                          <td><?php echo "<span class='label label-success'>".$row['status_vote_osis']."</span>";?></td>
                          <td><?php echo $row['vote_osis'];?></td>
                          <td><?php echo $row['vote_osis_time'];?></td>
                      </tr>
              <?php $no++; } ?>
