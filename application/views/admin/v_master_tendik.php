  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Master Data Tenaga Kependidikan
        <small>Tenaga Kependidikan yang terdaftar sebagai pemilih</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Master Data</a></li>
        <li class="active">Tenaga Kependidikan</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" style="width:100%">
                ...
                <tbody>
                <?php $no=1; foreach ($tendik as $row) { ?>
                        <tr>
                            <td><?php echo $no;?></td>
